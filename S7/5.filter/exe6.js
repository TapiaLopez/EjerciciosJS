// Dado el siguiente array, utiliza .filter() para generar un nuevo array con los streamers que incluyan el caracter 'Legends' 
...
let stream = streamers.filter(stre => stre.gameMorePlayed.includes('legends') );
